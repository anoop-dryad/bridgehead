...
import (
	...
	"github.com/anoop-dryad/bridgehead/internal/models"
	"github.com/hashicorp/golang-lru/v2/expirable"
)

// CacheService acts as the central hub for all in-memory data
type CacheService struct {
	UserCache *expirable.LRU[string, *models.User]
...
func NewCacheService() *CacheService {
	return &CacheService{
		...
		UserCache: expirable.NewLRU[string, *models.User](10000, nil, time.Minute),
